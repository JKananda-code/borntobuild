...
const HomePage = () => {
  return (
    <div className="relative w-full h-75 md:h-96">
      <div className="flex flex-wrap justify-center">
      <div className="absolute inset-0 bg-blue-500 bg-opacity-50 flex flex-col justify-center items-center p-4 text-white overflow-y-auto m-4">
